declare module "@salesforce/schema/ContactChangeEvent.Acceptance_Rate__c" {
  const Acceptance_Rate__c:number;
  export default Acceptance_Rate__c;
}
...
declare module "@salesforce/schema/ContactChangeEvent.Deals_Accepted__c" {
  const Deals_Accepted__c:number;
  export default Deals_Accepted__c;
}
declare module "@salesforce/schema/ContactChangeEvent.Deals_Rejected__c" {
  const Deals_Rejected__c:number;
  export default Deals_Rejected__c;
}
