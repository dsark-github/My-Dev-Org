declare module "@salesforce/schema/Contact.Acceptance_Rate__c" {
...
declare module "@salesforce/schema/Contact.Deals_Accepted__c" {
  const Deals_Accepted__c:number;
  export default Deals_Accepted__c;
}
declare module "@salesforce/schema/Contact.Deals_Rejected__c" {
